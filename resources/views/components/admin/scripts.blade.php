...
<script src="{{ asset('admin-assets/vendor/emojionearea/dist/emojionearea.min.js') }}"></script>
...
<script src="{{ asset('nanopkg-assets/vendor/typed.js/lib/typed.min.js') }}"></script>
...
<script src="{{ asset('nanopkg-assets/js/typed-init.min.js') }}"></script>
